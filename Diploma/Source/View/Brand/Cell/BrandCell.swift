...
//  Diploma
//
//  Created by Askar Serikkhanov on 2/14/20.
...
class BrandCell: UITableViewCell {
    ...
    fileprivate lazy var containerView: UIView = {
        ...
        containerView.layer.borderColor = UIColor.blueMain.cgColor
...
extension BrandCell{
    func configUI() {
        ...
        [imgView, txtLabel, costLabel, typeLabel, line1, detailsButton, buyButton].forEach {
